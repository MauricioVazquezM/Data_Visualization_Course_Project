...
En este proyecto, nos enfocaremos en el desarrollo de una interfaz gráfica interactiva que permita a los usuarios visualizar mapas georreferenciados de diversos indicadores socioeconómicos y ambientales proporcionados por el Banco Mundial a lo largo del tiempo. Esta herramienta busca facilitar la exploración visual de patrones regionales y temporales en indicadores clave, tales como tasa de fertilidad, emisiones de CO2, acceso a educación, entre otros.
...
2. La filtración de entidades geográficas que no corresponden a países soberanos (por ejemplo, regiones, clasificaciones de ingreso, agrupaciones económicas), manteniendo únicamente datos de países.
...
_NOTA: En el mapa georreferenciado, los países que no cuentan con información disponible para el año x respecto al indicador son representados en color gris claro. Esta codificación visual permite distinguir claramente entre los países con datos válidos (representados con un degradado de color según su valor) y aquellos sin cobertura para dicho año, facilitando la interpretación de la distribución geográfica de la información y resaltando vacíos en la base de datos del Banco Mundial._
