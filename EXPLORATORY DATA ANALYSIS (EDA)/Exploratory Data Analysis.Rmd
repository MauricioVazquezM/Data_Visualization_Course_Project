...
# Seleccionar hasta 10 países aleatorios sin valores nulos
selected_countries <- filtered_countries %>%
  sample_n(min(n(), 10)) %>%  # Evita error si hay menos de 10 países
  pull(country_name)
...
data_long <- data %>%
  ...
  pivot_longer(cols = c("1980", "1985", "1990", "1995", "2000", "2005", "2010", "2015", "2020"), names_to = "Año", values_to = "Valor") %>%
...
ggplot(data_long, aes(x = Año, y = Valor, group = country_name, color = country_name)) +
  ...
  labs(
    ...
    subtitle = "Seleccuión de 10 paises aleatorios",
    x = "Año",
